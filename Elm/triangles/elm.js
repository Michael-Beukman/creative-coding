...
var $author$project$Render$triangles = F3(
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
										(-width) / 2,
										($elm$core$Basics$sqrt(2) * width) / 2)),
									$joakin$elm_canvas$Canvas$lineTo(
									_Utils_Tuple2(
										width / 2,
										($elm$core$Basics$sqrt(2) * width) / 2)),
			...
			(width < 100) ? _List_Nil : A3(
				...
				A2(
					...
					function (_v0) {
						...
						var h = _v0.b;
						return A3(
							$author$project$Render$triangles,
							model,
							_Utils_Tuple2((translatePos.a + ((1 * width) / 4)) + ((w * width) / z), (translatePos.b + ((1 * width) / 8)) + ((h * width) / z)),
							width / 2);
					},
					_List_fromArray(
						[
